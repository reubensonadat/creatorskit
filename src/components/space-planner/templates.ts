...
export const CREATOR_TEMPLATES: Record<CreatorTemplateId, CreatorTemplate> = {
  podcast: {
    ...
    items: [
      ...
      { equipmentId: 'webcam', x: -0.3, z: -0.6, rotationY: Math.PI, parentId: 3 },
      { equipmentId: 'desk-lamp', x: 0.3, z: -0.6, rotationY: 0, parentId: 3 },
  ...
  'product-photography': {
    ...
    items: [
      ...
      { equipmentId: 'power-strip', x: 1.2, z: -0.8, rotationY: 0, parentId: 8 },
