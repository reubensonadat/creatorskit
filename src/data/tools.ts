...
export const NATIVE_TOOLS: ToolItem[] = [
  ...
  },
  {
    ...
    href: '/beat-sync',
    hint: 'BPM & TRANSIENTS',
    desc: 'Automatic audio beat detection, Premiere/DaVinci EDL markers, and kinetic video cut points',
    isFlagship: true,
    category: 'audio',
    badge: 'NEW',
  },
  {
    label: 'Silence & Jump-Cut Trimmer',
    href: '/silence-trimmer',
    hint: 'FAST PACING',
    desc: 'Sub-frame dead air & pause detection for high-retention YouTube & TikTok jump-cuts',
    isFlagship: true,
    category: 'audio',
    badge: 'RETENTION',
  },
  {
    label: 'Auto-Captions & Subtitle Studio',
    href: '/auto-captions',
    hint: 'KINETIC SUBTITLES',
    desc: 'Sub-word synchronized subtitles, viral Hormozi style kinetic animations, and SRT/VTT export',
    isFlagship: false,
    category: 'motion',
  },
  {
